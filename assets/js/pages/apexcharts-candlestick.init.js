...
var chartCandlestickBasicChart = "",
  chartCandlestickComboChart = "",
  chartCandlestickCombo2Chart = "",
  chartCandlestickCategoryChart = "",
  chartCandlestickLineChart = "";
function loadCharts() {
  var e, t;
  (t = getChartColorsArray("basic_candlestick")) &&
    ((e = {
      series: [
        {
          data: [
      ...
      plotOptions: {
        candlestick: { colors: { upward: t[0], downward: t[1] } },
      },
      title: {
    ...
    "" != chartCandlestickBasicChart && chartCandlestickBasicChart.destroy(),
    (chartCandlestickBasicChart = new ApexCharts(
      document.querySelector("#basic_candlestick"),
      e
    )).render()),
    (t = getChartColorsArray("combo_candlestick")) &&
      ((e = {
      ...
      "" != chartCandlestickComboChart && chartCandlestickComboChart.destroy(),
      (chartCandlestickComboChart = new ApexCharts(
        document.querySelector("#combo_candlestick"),
        e
      )).render()),
    getChartColorsArray("combo_candlestick_chart") &&
      ((t = {
      ...
      (chartCandlestickCombo2Chart = new ApexCharts(
        document.querySelector("#combo_candlestick_chart"),
        t
      )).render()),
    (t = getChartColorsArray("category_candlestick")) &&
      ((e = {
        series: [
          {
            name: "candle",
          ...
          xaxis: [
            {
              ...
              label: {
                borderColor: t[1],
                style: { fontSize: "12px", color: "#fff", background: t[1] },
      ...
      (chartCandlestickCategoryChart = new ApexCharts(
        document.querySelector("#category_candlestick"),
        e
      )).render());
  (t = getChartColorsArray("candlestick_with_line")) &&
    ((e = {
      series: [
        {
          name: "line",
    ...
    "" != chartCandlestickLineChart && chartCandlestickLineChart.destroy(),
    (chartCandlestickLineChart = new ApexCharts(
